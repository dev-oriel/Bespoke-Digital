    ...
    <div className="relative z-10 py-16 lg:py-24 px-6 max-w-5xl mx-auto">
      ...
      >
        ...
        <section className="glass-card p-8 md:p-12 rounded-[2rem] space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              <input
                className="w-full bg-slate-900/50 border border-slate-700 focus:border-primary focus:ring-1 focus:ring-primary rounded-xl px-5 py-4 text-white outline-none transition-all placeholder-slate-600"
        ...
        <section className="glass-card p-8 md:p-12 rounded-[2rem] space-y-8">
          ...
          <div className="space-y-8">
            <div className="space-y-3">
              ...
              <textarea
                className="w-full bg-slate-900/50 border border-slate-700 focus:border-primary focus:ring-1 focus:ring-primary rounded-xl px-5 py-4 text-white outline-none transition-all placeholder-slate-600 resize-none"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-3">
                ...
                <div className="h-full min-h-[120px] bg-slate-900/50 rounded-xl flex flex-col items-center justify-center gap-3 hover:border-primary transition-all cursor-pointer group border-dashed border-2 border-slate-700 py-6">
                  <div className="size-12 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-primary/20 transition-all text-slate-400 group-hover:text-primary">
          ...
          <div className="space-y-10">
              ...
              <div className="flex bg-slate-900 p-1.5 rounded-2xl border border-slate-800">
                {["Software", "Web App"].map((type) => (
                  <button
                    ...
                    className={`px-8 py-3 rounded-xl font-bold text-sm transition-all ${projectType === type ? "bg-primary text-white shadow-lg shadow-primary/30" : "text-slate-400 hover:text-white"}`}
                    type="button"
                  >
                    {type}
                  </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {[
                    ...
                    <label
                      key={feature}
                      className="flex items-center gap-4 p-4 rounded-xl bg-slate-900/50 border border-slate-800 cursor-pointer hover:border-primary/50 transition-colors"
                    >
                      <input
                        className="size-5 rounded border-slate-600 bg-slate-800 text-primary focus:ring-primary focus:ring-offset-0"
                        type="checkbox"
                      />
              ...
              <div className="space-y-3">
                ...
                <textarea
                  className="w-full h-full min-h-[160px] bg-slate-900/50 border border-slate-700 focus:border-primary focus:ring-1 focus:ring-primary rounded-xl px-5 py-4 text-white outline-none transition-all placeholder-slate-600 resize-none"
            ...
            {[
              ...
              <div
                ...
                className={`p-8 rounded-2xl cursor-pointer transition-all border-2 relative overflow-hidden group
                  ${engagement === option.id ? "border-primary bg-primary/10" : "border-slate-800 bg-slate-900/50 hover:border-primary/50"}`}
              >
        ...
        <div className="pt-8 pb-12 flex flex-col items-center gap-6">
          <button
            className="w-full md:w-auto min-w-[400px] bg-primary text-white text-xl font-black py-6 px-12 rounded-full shadow-[0_0_30px_rgba(60,131,246,0.4)] hover:shadow-[0_0_50px_rgba(60,131,246,0.6)] hover:-translate-y-1 transition-all tracking-wide"
            type="submit"
          >
            Submit Discovery Board
          </button>
          <div className="flex items-center gap-2 px-6 py-3 rounded-full bg-slate-900/80 border border-slate-800 text-slate-300 text-sm font-medium">
