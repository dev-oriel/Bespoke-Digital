  ...
  return (
    <div className="relative z-10">
      ...
      <section className="py-16 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="absolute top-1/2 left-0 w-full h-0.5 bg-slate-800 -translate-y-1/2 z-0 hidden lg:block"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 relative z-10">
              {timelineSteps.map((step, i) => (
                ...
                >
                  <div
                    className={`size-16 rounded-full flex items-center justify-center ring-8 ring-[#0f172a] transition-transform group-hover:scale-110 shadow-xl
                    ${
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
              <div className="space-y-8">
                ...
                <div className="p-6 bg-primary/10 border-l-4 border-primary rounded-r-xl">
                  <p className="italic text-slate-200 font-semibold">
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto border-t border-slate-800 pt-16">
      ...
      <section className="py-32 px-6 relative">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <button className="w-full sm:w-auto px-12 py-5 bg-transparent border-2 border-slate-700 text-white rounded-full text-lg font-black hover:bg-slate-800 hover:border-slate-600 transition-all">
              View Portfolio
            </button>
          </div>
